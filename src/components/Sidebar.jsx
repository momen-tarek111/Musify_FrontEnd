  ...
  return (
    <div className='w-[25%] h-full p-2 flex-col gap-2 text-white hidden lg:flex'>
        <div className='bg-[#121212] h-[15%] rounded flex flex-col justify-around'>
            <div onClick={()=>navigate("/")} className='flex items-center gap-3 pl-8 cursor-pointer hover:text-green-400 transition-colors'>
                <Home className="w-6 h-6"/>
                <p className='font-bold'>Home</p>
            </div>
            <div className='px-4 py-2'>
                {!showSearchInput?(
                    <div onClick={handleSearchClick} className='flex items-center gap-3 pl-4 cursor-pointer hover:text-green-400 transition-colors'>
                    ...
                    <div className='flex items-center gap-2 pl-4'>
                        ...
                        <input 
                            ...
                            autoFocus
                        />
                        <button onClick={handleClearSearch} className='p-1 hover:bg-gray-700 rounded-full transition-colors'>
