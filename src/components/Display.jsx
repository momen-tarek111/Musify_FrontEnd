...
function Display() {
  ...
  return (
    <div ref={displayRef} className="w-[100%] m-2 bg-[#121212] text-white lg:w-[75%] lg:ml-0 flex flex-col">
      <div className="sticky top-0 z-10 bg-[#121212]/95 backdrop-blur-sm border-gray-800/50 px-6 pt-4 pb-2">
        <Navbar/>
      </div>
      <div className="flex-1 px-6 pb-4 overflow-auto custom-scrollbar">
        <Routes>
